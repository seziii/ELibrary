<%@ Page Title="" Language="C#" MasterPageFile="~/ElibraryMaster.Master" AutoEventWireup="true" CodeBehind="UspeshnoPlashtane.aspx.cs" Inherits="ELibrary.UspeshnoPlashtane" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnOtkaz" runat="server" Height="26px" Text="Отказ" Width="143px" />
&nbsp;<asp:Button ID="btnPotvardi" runat="server" Text="Потвърждаване" />
</asp:Content>
